...
{
    public class StoreImagesController : Controller
    {
        public ActionResult Render(string file)
        {
            ...
            if (this.ImageFileNotAvailable(fullFilePath))
            {
                ...
                return new ImageFileResult(string.Format("{0}/{1}", Server.MapPath("~/App_Data/Images/Stores"), "default.png"));
            }
        ...
        {
            return string.Format("{0}/{1}", Server.MapPath("~/App_Data/Images/Stores"), file);
        }
